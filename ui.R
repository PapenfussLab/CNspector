...
#                          step=10, round=0)
      ...
      column(2,
             ...
             uiOutput("display_off_target_data")
...
#              checkboxInput(inputId = "display_off_target_data", label = "Off Target",value = FALSE)
      ),
      column(2,
             uiOutput("use_reference_wg"),
             uiOutput("use_reference_targeted"),
             uiOutput("use_reference_off_target")
...
#              checkboxInput(inputId = "use_reference_off_target", label = "Use reference for Off Target",value = TRUE)
      ),
      column(2,
             uiOutput("gc_correct_wg"),
             uiOutput("gc_correct_targeted"),
             uiOutput("gc_correct_off_target"),
...
#              checkboxInput(inputId = "gc_correct_off_target", label = "GC correct Off Target",value = FALSE)
      ),
      column(2,
